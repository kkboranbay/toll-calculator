...
type AggregatorClient interface {
	Aggregate(ctx context.Context, in *AggregatorRequest, opts ...grpc.CallOption) (*None, error)
}
...
func (c *aggregatorClient) Aggregate(ctx context.Context, in *AggregatorRequest, opts ...grpc.CallOption) (*None, error) {
	out := new(None)
...
type AggregatorServer interface {
	Aggregate(context.Context, *AggregatorRequest) (*None, error)
...
func (UnimplementedAggregatorServer) Aggregate(context.Context, *AggregatorRequest) (*None, error) {
