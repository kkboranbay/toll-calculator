...
func NewKafkaConsumer(topic string, srv CalculatorServicer, aggrClient *client.HttpClient) (*KafkaConsumer, error) {
...
func (c *KafkaConsumer) readMessageLoop() {
	for c.isRunning {
		...
		if err := c.aggrClient.AggregateInvoice(req); err != nil {
